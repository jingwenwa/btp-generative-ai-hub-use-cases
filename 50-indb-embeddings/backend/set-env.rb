...
cf set-env ui5-mha-poc KG_ENDPOINT https://kgapp.cfapps.ap10.hana.ondemand.com
cf set-env ui5-mha-poc PY_ENDPOINT https://indb-embedding.cfapps.ap10.hana.ondemand.com